        ...
        >
          <div className="mx-3 rounded-xl bg-white p-8 text-center shadow-basic">
            ...
            <p className="font-thin">
              Unlock a world of possibilities and never feel stuck again. The
          ...
          <div className="mx-3 rounded-xl bg-white p-8 text-center shadow-basic">
            ...
            <p className="font-thin">
              Each how-to guide provides easy-to-follow step-by-step
              instructions to help you solve problems with confidence.
            </p>
          </div>
          <div className="mx-3 rounded-xl bg-white p-8 text-center shadow-basic">
